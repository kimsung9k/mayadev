...
class WinA_Global:
    ...
    winName = sgBModel_sgPWindow.sgPWindow_file_key_import_winName
    title   = "Import Key"
    width   = 500
    height  = 50
    titleBarMenu = True
...
class WinA_Cmd:
    ...
    def cmdImport( *args ):
        ...
        try:importPath = cmds.textField( WinA_Global.importPath_txf, q=1, tx=1 )
        except: return None
...
mc_showWindow = """import sgPWindow_file_key_import
sgPWindow_file_key_import.WinA().create()"""