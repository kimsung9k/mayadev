...
class WinA_Global:
    ...
    infoFolderPath = sgBFunction_fileAndPath.getLocusCommPackagePrefsPath() + '/sgPWindow_data_cache_export'
    infoPathPath = sgBFunction_fileAndPath.getLocusCommPackagePrefsPath() + '/sgPWindow_data_cache/filePath.txt'
    infoPath = sgBFunction_fileAndPath.getLocusCommPackagePrefsPath() + '/sgPWindow_data_cache_export/info.txt'
...
mc_showWindow = """import sgPWindow_data_cache_export
sgPWindow_data_cache_export.WinA().create()"""