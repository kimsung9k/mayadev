...
class Window:
    ...
    def __init__(self):
        ...
        self._winName = uiModel.WindowInfo._winName
        self._title   = uiModel.WindowInfo._title
        self._width   = uiModel.WindowInfo._width
        self._height  = uiModel.WindowInfo._height
    ...
    def cmdCreate( self, *args ):
        ...
        if cmds.radioButton( self._radio1, q=1, sl=1 ):
            ...
            cmdModel.createJointOnCurve( numJoint, checkValue )
        else:
            multRate = cmds.floatSliderGrp( self._slider2, q=1, v=1 )
            cmdModel.createJointOnCurveByLength( multRate, checkValue )
