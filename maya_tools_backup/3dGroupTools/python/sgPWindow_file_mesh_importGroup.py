...
class WinA_Global:
    ...
    uiInfo = sgBFunction_fileAndPath.getLocusCommPackagePrefsPath() + '/sgPWindow_file_mesh_importGroup/info.txt'
...
mc_showWindow = """import sgPWindow_file_mesh_importGroup
sgPWindow_file_mesh_importGroup.WinA().create()"""