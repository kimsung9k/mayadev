...
MTypeId     followMatrix::id( 0x83008 );

MObject     followMatrix::originalMatrix;
MObject     followMatrix::inputMatrix;
MObject     followMatrix::inputWeight;
MObject     followMatrix::outputMatrix;

followMatrix::followMatrix() {}
followMatrix::~followMatrix() {}

MStatus followMatrix::compute( const MPlug& plug, MDataBlock& data )
{
	...
	if( plug == outputMatrix )
	{
		...
		MDataHandle outputHandle = data.outputValue( followMatrix::outputMatrix );
...
void* followMatrix::creator()
{
	return new followMatrix();
}

MStatus followMatrix::initialize()	
{
