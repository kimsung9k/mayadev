...
// 
// File: sgMatrixToThreeByThreeNode.cpp
//
// Dependency Graph Node: sgMatrixToThreeByThree
//
...
MTypeId     sgMatrixToThreeByThree::id( 0x2014091000 );

MObject     sgMatrixToThreeByThree::inMatrix;
MObject     sgMatrixToThreeByThree::out00;
MObject     sgMatrixToThreeByThree::out01;
MObject     sgMatrixToThreeByThree::out02;
MObject     sgMatrixToThreeByThree::out10;
MObject     sgMatrixToThreeByThree::out11;
MObject     sgMatrixToThreeByThree::out12;
MObject     sgMatrixToThreeByThree::out20;
MObject     sgMatrixToThreeByThree::out21;
MObject     sgMatrixToThreeByThree::out22;

sgMatrixToThreeByThree::sgMatrixToThreeByThree() {}
sgMatrixToThreeByThree::~sgMatrixToThreeByThree() {}

bool sgMatrixToThreeByThree::allPlug( const MPlug& plug )
{
...
MStatus sgMatrixToThreeByThree::compute( const MPlug& plug, MDataBlock& data )
{
	...
	if( allPlug( plug ) )
	{
		...
		if( returnStatus != MS::kSuccess )
			MGlobal::displayError( "Node sgMatrixToThreeByThree cannot get value\n" );
		else
		{
			...
			MDataHandle out00Handle = data.outputValue( sgMatrixToThreeByThree::out00 );
			out00Handle.set( inMtx( 0,0 ) );
			MDataHandle out01Handle = data.outputValue( sgMatrixToThreeByThree::out01 );
			out01Handle.set( inMtx( 0,1 ) );
			MDataHandle out02Handle = data.outputValue( sgMatrixToThreeByThree::out02 );
			out02Handle.set( inMtx( 0,2 ) );
			MDataHandle out10Handle = data.outputValue( sgMatrixToThreeByThree::out10 );
			out10Handle.set( inMtx( 1,0 ) );
			MDataHandle out11Handle = data.outputValue( sgMatrixToThreeByThree::out11 );
			out11Handle.set( inMtx( 1,1 ) );
			MDataHandle out12Handle = data.outputValue( sgMatrixToThreeByThree::out12 );
			out12Handle.set( inMtx( 1,2 ) );
			MDataHandle out20Handle = data.outputValue( sgMatrixToThreeByThree::out20 );
			out20Handle.set( inMtx( 2,0 ) );
			MDataHandle out21Handle = data.outputValue( sgMatrixToThreeByThree::out21 );
			out21Handle.set( inMtx( 2,1 ) );
			MDataHandle out22Handle = data.outputValue( sgMatrixToThreeByThree::out22 );
...
void* sgMatrixToThreeByThree::creator()
{
	return new sgMatrixToThreeByThree();
}

MStatus sgMatrixToThreeByThree::initialize()	
{
