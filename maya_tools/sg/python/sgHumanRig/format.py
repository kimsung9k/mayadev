...
class BoundingBox:
    ...
    def __init__(self, shapeOrTransform ):
        ...
        isEnable = check.isTransformNode( self._target ) or check.isShapeNode( self._target )
        ...
        self._parentMatrix = convert.matrixFromList( cmds.getAttr( self._target + ".pm" ) )
...
class Mesh:
    ...
    def __init__(self, shape ):
        ...
        if type( shape ) == type( OpenMaya.MDagPath() ):
            ...
            if not check.isMesh( shape ): return None
            self.dagPath = sgbase.getDagPath( shape )
        else: return None
    ...
    def duplicateAndAddFace( self, indicesPoly ):
        ...
        newFnMesh.create( addNumVertices, addNumPolys, addPoints, addVerticesCounts, addVerticesList, sgbase.getMObject( newMeshTransform ) )
        ...
        cmds.parent( newMesh, dag.getTransform( origMeshName ), add=1, shape=1 )
...
class Curve:
    ...
    def __init__(self, curveShape ):
        ...
        self.dagPath = sgbase.getDagPath( curveShape )
...
class Node:
    ...
    def __init__(self, nodeName ):
        ...
        self.oNode = sgbase.getMObject( nodeName )
...
class DagNode( Node ):
    ...
    def __init__(self, dagNodeName ):
        ...
        self.fnDagNode = OpenMaya.MFnDagNode( sgbase.getDagPath(dagNodeName) )
