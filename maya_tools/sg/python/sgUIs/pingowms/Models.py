...
class EditorInfo:
    ...
    def setDict(self, dictObject ):
        self.id   = EditorInfo.getValueFromDict( dictObject, 'id' )
        self.host = EditorInfo.getValueFromDict( dictObject, 'host' )
        self.mtime = EditorInfo.getValueFromDict( dictObject, 'mtime' )
        self.references = EditorInfo.getValueFromDict( dictObject, 'references' )
