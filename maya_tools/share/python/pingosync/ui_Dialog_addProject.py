...
class Dialog_addProject( QDialog ):
    ...
    def getServerPath(self):
        ...
        resultPath = commands.FileControl.getFolderFromBrowser( self, commands.FileControl.getDefaultProjectFolder() )
    ...
    def getLocalPath(self):
        ...
        resultPath = commands.FileControl.getFolderFromBrowser( self, commands.FileControl.getDefaultLocalFolder() )
        if os.path.exists( resultPath ):
    ...
    def createProject(self):
        ...
        data["%s" % projName] = { Models.ControlBase.labelServerPath:"%s" % projPath, Models.ControlBase.labelLocalPath:"%s" % localPath }
        commands.ProjectControl.setProjectListData(data)
        self.close()
        
        Models.ControlBase.mainui.updateProjectList( projName )
