...
class WinA_Global:
    ...
    winName = sgBModel_sgPWindow.sgPWindow_file_meshGroup_export_winName
    ...
    uiInfo = sgBFunction_fileAndPath.getUiInfo_sgPWindow_file_meshGroup()
...
mc_showWindow = """import sgPWindow_file_mesh_exportGroup
sgPWindow_file_mesh_exportGroup.WinA().create()"""