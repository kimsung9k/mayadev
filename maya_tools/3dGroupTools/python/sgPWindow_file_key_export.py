...
class WinA_Global:
    ...
    winName = sgBModel_sgPWindow.sgPWindow_file_key_export_winName
    title   = "Export Key"
    width   = 500
    height  = 50
    titleBarMenu = True
    ...
    pathInfo = sgBFunction_fileAndPath.getPathInfo_sgPWindow_file_key()
    uiInfo   = sgBFunction_fileAndPath.getUiInfo_sgPWindow_file_key()
...
class WinA_Cmd:
    ...
    def read_windowInfo():
        ...
        try:
            ...
            exportPath, exportType, searchFor, searchForType, splitStringAndSerchCheck, splitStringAndSearchString, exportByMatrix = data
        except:
            sgBFunction_fileAndPath.makeFile( WinA_Global.uiInfo, False )
...
class WinA:
    ...
    def __init__(self):
        ...
        self.uiTimeRanges = WinA_TimeRanges( "Start Frame : ", "End Frame : ", "Step : ", 120, 50, 22 )
...
mc_showWindow = """import sgPWindow_file_key_export
sgPWindow_file_key_export.WinA().create()"""