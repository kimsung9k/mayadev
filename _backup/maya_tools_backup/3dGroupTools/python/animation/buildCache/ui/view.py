...
class BuildCacheUI:
    ...
    def __init__(self):
        ...
        self._winName = uiModel.BuildCacheUIInfo._winName
        self._title = uiModel.BuildCacheUIInfo._title
        self._width = uiModel.BuildCacheUIInfo._width
        self._height= uiModel.BuildCacheUIInfo._height
