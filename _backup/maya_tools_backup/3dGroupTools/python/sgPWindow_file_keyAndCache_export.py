...
class WinA_Global:
    ...
    infoPath = sgBFunction_fileAndPath.getLocusCommPackagePrefsPath() + '/sgPWindow_file_keyAndCache_export/info.txt'
...
class WinA_Cmd:
    ...
    def export( *args ):
        ...
        sgBExcute_data.exportKeyAndCacheData(keyTargets, cacheTargets, keyPath, cachePath, startFrame, endFrame, step, exportByMatrix, cacheType[cacheTypeIndex] )
...
mc_showWindow = """import sgPWindow_file_keyAndCache_export
sgPWindow_file_keyAndCache_export.WinA().create()"""