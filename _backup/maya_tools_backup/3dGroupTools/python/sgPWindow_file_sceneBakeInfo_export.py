...
class WinA_Global:
    ...
    winName = sgBModel_sgPWindow.sgPWindow_file_sceneBakeInfo_export_winName
...
mc_showWindow = """import sgPWindow_file_sceneBakeInfo_export
sgPWindow_file_sceneBakeInfo_export.WinA().create()"""