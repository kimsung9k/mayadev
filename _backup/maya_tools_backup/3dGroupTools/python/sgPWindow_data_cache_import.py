...
class WinA_Global:
    ...
    infoFolderPath = sgBFunction_fileAndPath.getLocusCommPackagePrefsPath() + '/sgPWindow_data_cache_import'
    infoPath = sgBFunction_fileAndPath.getLocusCommPackagePrefsPath() + '/sgPWindow_data_cache/filePath.txt'
...
mc_showWindow = """import sgPWindow_data_cache_import
sgPWindow_data_cache_import.WinA().create()"""