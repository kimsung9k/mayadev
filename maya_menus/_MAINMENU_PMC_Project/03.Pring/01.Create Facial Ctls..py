...
def getXYSlider( width, height, colorIndex = None, texturePath = '' ):
    ...
    eyeFileNode, textureNode = sgcommands.createTextureFileNode( texturePath )
...
def createRect( width, height ):
    rect = sgcommands.makeController( sgdata.Controllers.planPoints, 1, makeParent=1 )
...
cmds.parent( sliderBase1, sliderBase2, sliderBase3, rect )